...
- **This is the default value for all elements.Elements with position: static; are positioned according to the normal document flow.**
...
<html lang="en">
  ...
  <body>
    <h1 id="main-heading">CSS Positions- Static & Relative</h1>
    <hr />
    <br />
    <section class="parent-div">
      <div class="child child-1">child 1</div>
...
```
### Output
![image](https://github.com/user-attachments/assets/6847cea0-a737-4685-ae67-dff15c424cf7)
