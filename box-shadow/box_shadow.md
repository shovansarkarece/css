...
.shadow {
  ...
  -o-border-radius: 50%;
  /*? box shadow here  */
  box-shadow: 0px 40px 0 60px #ffb000;////-->2nd parameter is for Offset-Y  means horizontally it will shift
}
```
## Output
...
.shadow {
  ...
  /*? box shadow here  */
   /* blur-radius */
   box-shadow: 0px 0px 30px 60px #ffb000;////-->3rd parameter is for blur-radius
}
```

## output
![image](https://github.com/user-attachments/assets/1b4f7d1d-ab6a-4228-90a9-0d78c7345b40)
